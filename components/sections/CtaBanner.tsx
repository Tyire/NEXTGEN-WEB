...
export function CtaBanner({
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--color-ink)] py-24">
      ...
      <span className="aurora pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[720px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--color-brand-orange)] opacity-[0.14] blur-[120px]" />
